...
class EquipmentService {
  ...
  * 6. Process response
  **/
   async makeEquipment(userName, farmer, equipmentNumber, equipmentName, ownerName) {
    ...
    try {
      ...
      const response = await contract.submitTransaction('makeEquipment', farmer, equipmentNumber, equipmentName, ownerName);
