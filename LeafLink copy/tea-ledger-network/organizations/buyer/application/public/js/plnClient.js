...
$(document).ready(function(){
  ...
  var tabs =["addToWallet", "buyerReceived", "query", "queryHistory"];
  $("#queryResult").hide();
  $("#addToWalletLink").click(function(){
    showTab("addToWallet");
  });
  $("#buyerReceivedLink").click(function(){
    showTab("buyerReceived");
  });
 ...
 $("#addUser").click(function(){
  ...
  $("#buyerReceived").click(function(){
    var buyerReceivedUrl = urlBase+"/buyerReceived";
    var formData = {
    ...
    $.ajax({
      type: 'POST',
      url: buyerReceivedUrl,
      data: formData,
      success: function(data, status, jqXHR){
        if(status==='success'){
          alert("successfully record buyerReceived  in blockchain");
       }
        showTab("query");
      },
      error: function(xhr, textStatus, error){
