/*
 ...
 # Author: Brian Wu
 # WholesalerService -transporterDistribute:
 */
...
class WholesalerService {
  ...
  * 4. Construct request to transporterDistribute
  * 5. Submit invoke transporterDistribute transaction
  * 6. Process response
  **/
   async transporterDistribute(userName, equipmentNumber, ownerName) {
    ...
    try {
      ...
      const response = await contract.submitTransaction('transporterDistribute', equipmentNumber, ownerName);
